...
const fn should_persist_retry_packet(transition: StageTransitionKey, stage: Stage) -> bool {
...
#[cfg(test)]
mod runtime_tests {
    use super::should_persist_retry_packet;
    use swarm::{RuntimeStageTransition as StageTransitionKey, Stage};
